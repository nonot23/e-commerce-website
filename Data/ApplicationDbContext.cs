...

{
    ...
    {
        base.OnModelCreating(modelBuilder); // ถ้าคุณไม่เรียก EF Core จะไม่รู้จักการตั้งค่าเหล่านี้ และจะไม่สร้างตาราง Identity ให้ครบ
        ...
        modelBuilder.Entity<product>(entity =>
        {
            ...
            entity.Property(e => e.unit_price).HasPrecision(18,2);
